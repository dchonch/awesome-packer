...
> **Note:** In August 2023, HashiCorp relicensed Packer (and all its products) from MPL 2.0 to the [Business Source License (BSL 1.1)](https://www.hashicorp.com/bsl). The source code remains publicly available; production use by competing vendors is restricted. There is currently no community fork equivalent to Packer.
...
- [Packer Tutorials](https://developer.hashicorp.com/packer/tutorials) — Hands-on guides from HashiCorp.
...
- **[Packer v1.15 (March 2026)](https://developer.hashicorp.com/packer/docs/release-notes)** — Latest stable release. Native Linux ARM64 support, improved plugin loading reliability, and `packer fmt` multi-file formatting.
- **[HCP Packer SBOM — GA (HashiConf 2025)](https://www.hashicorp.com/blog/scale-infrastructure-with-new-terraform-and-packer-features-at-hashiconf-2025)** — Software Bill of Materials upload and storage is now generally available. Package name and version visibility in the HCP UI is in public beta.
- **[HCP Packer CI/CD Pipeline Metadata — GA (HashiConf 2024)](https://www.hashicorp.com/blog/terraform-packer-nomad-and-waypoint-updates-help-scale-ilm-at-hashiconf-2024)** — Track pipeline IDs and job details from GitHub, GitLab, BitBucket, and Jenkins alongside artifact metadata.
- **[HCP Packer v2 Nomenclature](https://developer.hashicorp.com/hcp/docs/packer)** — "Iterations" renamed to Versions; "Images" renamed to Artifacts. Bucket-level RBAC is now generally available.
- **[Official Plugin Distribution Moved (August 2025)](https://discuss.hashicorp.com/t/important-update-official-packer-plugin-distribution-moving-to-releases-hashicorp-com/75972)** — HashiCorp-maintained plugins now distributed from `releases.hashicorp.com`. Packer v1.14.0+ handles this automatically with no user action required.
- **[HCL2 as Standard Format](https://developer.hashicorp.com/packer/docs/templates/json_to_hcl)** — JSON templates are legacy since v1.7.0. HCL2 is the recommended and actively developed format. Use `packer hcl2_upgrade` to migrate.
- **[BSL Relicense (August 2023)](https://www.hashicorp.com/blog/hashicorp-adopts-business-source-license)** — Packer moved from MPL 2.0 to Business Source License. See the [licensing FAQ](https://www.hashicorp.com/license-faq) for details.
...
- [packer-plugin-scaffolding](https://github.com/hashicorp/packer-plugin-scaffolding) — Official template repository for bootstrapping new HCL2-native plugins.

## HCP Packer

[HCP Packer](https://developer.hashicorp.com/hcp/docs/packer) is HashiCorp's cloud service for tracking and managing Packer build artifacts across your organization. Available in Essentials (free) and Standard (paid) editions.
...
- [Automate Packer with GitHub Actions + HCP](https://developer.hashicorp.com/packer/tutorials/cloud-production/github-actions) — Push artifact metadata to HCP Packer from GitHub Actions.
...
Official Packer integrations for major platforms. Full list: [developer.hashicorp.com/packer/integrations](https://developer.hashicorp.com/packer/integrations).
...
- [HCP CI/CD Pipeline Metadata](https://www.hashicorp.com/blog/hcp-packer-now-tracks-ci-cd-pipeline-metadata) — Store GitHub, GitLab, BitBucket, and Jenkins pipeline context alongside HCP Packer artifacts.
...
- [Using GitLab CI/CD to Automate Packer Builds](https://mpoore.io/posts/2024/using-gitlab-ci-cd-to-automate-my-packer-builds/) — Practical 2024 guide with real pipeline configuration.
...
- [Build EC2 Images with Packer & Ansible for Immutable AWS Deployments](https://medium.com/devopslinks/build-your-own-ec2-machine-images-with-packer-ansible-on-aws-for-immutable-aws-deployments-f7dbe81934a1) — AMI automation combined with Ansible configuration management.
- [Upgrade JSON Packer Templates to HCL2](https://developer.hashicorp.com/packer/tutorials/configuration-language/hcl2-upgrade) — Official migration tutorial using `packer hcl2_upgrade`.
- [StackExchange: Questions tagged \[packer\]](https://devops.stackexchange.com/questions/tagged/packer) — Community Q&A on DevOps Stack Exchange.
...
- [Scale Infrastructure with New Terraform and Packer Features — HashiConf 2025](https://www.hashicorp.com/blog/scale-infrastructure-with-new-terraform-and-packer-features-at-hashiconf-2025) — SBOM GA, Package Visibility beta, and HCP Packer updates.
- [Terraform, Packer, Nomad, and Waypoint Updates — HashiConf 2024](https://www.hashicorp.com/blog/terraform-packer-nomad-and-waypoint-updates-help-scale-ilm-at-hashiconf-2024) — CI/CD metadata tracking and bucket-level RBAC announcements.
...
- [Packer @ Pinterest](https://youtu.be/L-DMwEN_mUk) — How Pinterest scaled machine image creation with Packer.

## Community

- [HashiCorp Discuss — Packer](https://discuss.hashicorp.com/c/packer) — Official forum for Packer questions, announcements, and feedback from the HashiCorp team.
